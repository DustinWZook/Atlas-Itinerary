          ...
          <section className="instruction-sections">
            ...
            <div id="step-7" className="instructions step-card">
              ...
              <p>
                ...
                or click <strong>Cancel</strong> to continue browsing.
                <br />(image of expanded venue card)
              </p>
              <Image className="image-container" src={testImg} alt="Example venue card" />
            </div>
            ...
            <div id="step-9" className="instructions step-card">
              ...
              <p>
                Select the <strong>start date</strong>, <strong>end date</strong>, <strong>start time</strong>,
                and <strong>end time</strong> for the venue.
                Once everything looks correct, you&apos;re ready to add it to your calendar.
                <br />(image of calendar with example data)
              </p>
              <Image className="image-container" src={testImg} alt="Calendar example" />
            </div>
            ...
            <div id="step-12" className="instructions step-card">
              ...
              <Image className="image-container" src={testImg} alt="Itinerary list" />
            </div>
          </section>
        </div>
      </main>
